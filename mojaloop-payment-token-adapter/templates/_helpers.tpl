...
*/}}
{{- define "mojaloop-payment-token-adapter.name" -}}
...
*/}}
{{- define "mojaloop-payment-token-adapter.fullname" -}}
...
*/}}
{{- define "mojaloop-payment-token-adapter.chart" -}}
...
Common labels
*/}}
{{- define "mojaloop-payment-token-adapter.labels" -}}
app.kubernetes.io/name: {{ include "mojaloop-payment-token-adapter.name" . }}
helm.sh/chart: {{ include "mojaloop-payment-token-adapter.chart" . }}
